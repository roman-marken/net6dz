namespace SpanishFootballChampionship.Sql;

public static class SqlServerScripts
{
    public static IReadOnlyList<string> All =>
    [
        CreatePlayerScoringStatsView,
        CreateTeamGoalStatsView,
        CreateTeamPointStatsView,
        CreateFillMatchesRandomProcedure
    ];

    public const string CreatePlayerScoringStatsView = """
    ...
    public const string CreateTeamGoalStatsView = """
    ...
    public const string CreateTeamPointStatsView = """
    ...
    public const string CreateFillMatchesRandomProcedure = """
